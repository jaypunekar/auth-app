...
const InstagramAnalyzer = () => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await axios.get(`/api/social-media/instagram-analysis?username=${encodeURIComponent(username)}`);
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h4" gutterBottom>
        <Instagram color="primary" sx={{ mr: 1, verticalAlign: 'middle' }} />
        Instagram Profile Analyzer
      </Typography>
      <Typography variant="subtitle1" gutterBottom>
        Analyze Instagram profiles to get insights and metrics about engagement, influence, and audience.
      </Typography>
